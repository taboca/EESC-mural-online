	...
	__feedUpdated : function(result) {
		...
		var cc=0;
     		...
     		$(result.xmlDocument).find('item').each(function(){
                        ...
                        if(cc>=0) {
                                self.tweetQueue.push( '<div class="defesas"><div class="defesa_titulo">'+title+'</div><div class="defesa_descricao">'+desc+'</div><div class="defesa_orientador"><h3>Orientador</h3><p>'+ref+'</p></div> <div class="defesa_datahora">'+data+' | ' + hora + ' </div> <div class="defesa_local">'+local+'</div></div>');
                                cc++;
                        }
                });
